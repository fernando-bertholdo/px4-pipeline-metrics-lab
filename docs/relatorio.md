...
|----------|---|-----------------|------------|--------|
| baseline | 3 | 28.0 | 2.6 | 98 |
| baseline_final | 1 | 31.0 | — | 98 |
| failing | 1 | 25.0 | — | 98 |
| jobs_parallel | 2 | 17.5 | 0.7 | 98 |
| jobs_parallel_2x | 1 | 15.0 | — | 178 |
| no_cache | 2 | 26.0 | 2.8 | 98 |
| pytest_parallel | 2 | 30.5 | 2.1 | 98 |
| pytest_parallel_4x | 1 | 29.0 | — | 338 |
| slow_test | 1 | 60.0 | — | 99 |
| tests_2x | 1 | 30.0 | — | 178 |
| tests_4x | 1 | 24.0 | — | 338 |
| tests_8x | 1 | 33.0 | — | 658 |
...
python3 scripts/collect_metrics.py --repo fernando-bertholdo/px4-pipeline-metrics-lab --only-logged
pip install -r requirements-analysis.txt
python3 scripts/make_graphs.py
python3 scripts/build_report.py --repo fernando-bertholdo/px4-pipeline-metrics-lab
```
